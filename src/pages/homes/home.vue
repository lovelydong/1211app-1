<template>
	<f7-page class="home">
		...
		<f7-toolbar>
			...
			<f7-link href="/questionBankhome" :reload-all="true" :animate="true"><span></span>
				<p>题库</p>
			</f7-link>
		...
		<div class="top">
			...
			<div class="seek">
				<f7-link href="/search/"><i class="iconfont icon-sousuo"></i>请输入想要搜索内容</f7-link>
			</div>
		</div>
		<div class="mid">
			<div class="midtop">
		...
		.navbar-inner {
			...
			.lf {
				...
				.active::before {
					...
					width: 30%;
					height: 3px;
					background-image: linear-gradient(#fd2d44, #fd2d44), linear-gradient(#fd2d44, #fd2d44);
				...
				.swiper-container {
					...
					.swiper-pagination-bullets {
						...
						.swiper-pagination-bullet-active {
							...
							background-image: linear-gradient(#fd2d44, #fd2d44), linear-gradient(#fd2d44, #fd2d44);
							background-blend-mode: normal, normal;
							box-shadow: 0px 0px 5px 0px rgba(253, 45, 68, 0.5);
							border-radius: 4px;
						}
					}
				}
						...
						.swiper-wrapper {
							.swiper-slide {
								...
								>div {
									...
									width: 100%;
									text-align: center;
									background: url(../../assets/hometui.png) no-repeat center center;
									border-radius: 10px;
									>.link {
										width: 100%;
										height: 100%;
