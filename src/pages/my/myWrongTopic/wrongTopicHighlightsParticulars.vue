  ...
  <f7-page class="wrongTopicHighlightsParticulars">
        ...
        <div class="mid">
          <f7-swiper pagination>
              <f7-swiper-slide v-for="(e,index) in errordetail.dx" v-if="errordetail.dx.length" >
                <h3>单选题</h3>

                <div class="content">
                    <p>{{e.itemname}}</p>
                    <ul>
                        <f7-link v-for="(ee,index) in errordetail.dxa" v-if="e.id==ee.itemid"> <span>A</span>{{ee.optionname}}</f7-link>
                    ...
                    <div class="bot">
                        ...
                        <div v-for="(eee,index) in errordetail.dxanswer" v-if="e.id==eee.itemid">{{eee.analysis}}</div>
                    </div>
                </div>
              </f7-swiper-slide>
              
              <f7-swiper-slide v-for="(e,index) in errordetail.dxs" v-if="errordetail.dxs.length" >
                <h3>多选题</h3>

                <div class="content">
                    <p>{{e.itemname}}</p>
                    <ul>
                        <f7-link v-for="(ee,index) in errordetail.dxsa" v-if="e.id==ee.itemid"> <span>A</span>{{ee.optionname}}</f7-link>
                       <!-- <f7-link class="active"> <span>B</span>灯比原来亮了</f7-link>
                        <f7-link class="active1"> <span>C</span>灯比原来亮了</f7-link>-->
                    </ul>
                    <div class="bot">
                        ...
                        <div v-for="(eee,index) in errordetail.dxsanswer" v-if="e.id==eee.itemid">{{eee.analysis}}</div>
                    </div>
                </div>
              </f7-swiper-slide>
